                                            ...
                                            <li class="mb-10 ms-6">
                                                ...
                                                @if($case->status == 'Aceptado')
                                                    <span
                                                        class="absolute flex items-center justify-center w-6 h-6 bg-green-300 rounded-full -start-3 ring-8 ring-white">
                                                         <img src="{{asset('svg/approved.svg')}}" class="w-5 h-5" alt="icon"/>
                                                    </span>
                                                @elseif($case->status == 'Pendiente')
                                                    <span
                                                        class="absolute flex items-center justify-center w-6 h-6 bg-blue-300 rounded-full -start-3 ring-8 ring-white">
                                                         <img src="{{asset('svg/pending.svg')}}" class="w-11" alt="icon"/>
                                                    </span>
                                                @elseif($case->status == 'Rechazado')
                                                    <span
                                                        ...
                                                        <img src="{{asset('svg/rejected.svg')}}" class="w-4 h-4" alt="icon"/>
                                                    </span>
                                                @endif
                                                ...
                                                <div
                                                    ...
                                                    @if($case->status == 'Aceptado')
                                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-300">Se ha aceptado el caso
                                                            <a href="{{route('cases.show',$case->id)}}"
                                                                     class="font-semibold text-blue-600 dark:text-blue-500 hover:underline">{{$case->title}}
                                                            </a>
                                                        </div>
                                                    @elseif($case->status == 'Rechazado')
                                                            <div class="text-sm font-normal text-gray-500 dark:text-gray-300">Se ha rechazado el caso
                                                                <a href="{{route('cases.show',$case->id)}}"
                                                                   class="font-semibold text-blue-600 dark:text-blue-500 hover:underline">{{$case->title}}
                                                                </a>
                                                            </div>
                                                    @elseif($case->status == 'Pendiente')
                                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-300">
                                                            <p class="font-semibold inline-block">{{$case->user->name}} {{$case->user->last_name}}</p>
                                                             ha subido el caso
                                                            <a href="{{route('cases.show',$case->id)}}"
                                                               class="font-semibold text-blue-600 dark:text-blue-500 hover:underline">{{$case->title}}
                                                            </a>

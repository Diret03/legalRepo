...
<!-- Add case modal -->
<div id="add-case-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                        ...
                        data-modal-hide="add-case-modal">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{ route('trials.store') }}" method="POST">
                    ...
                    <div>
                        ...
                        <select name="trial_id" id="trial_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <div>
                        <label for="context"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contexto</label>
                        <textarea name="context" id="context"
                                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                  required >{{ old('context') }}</textarea>
                    </div>
                    <div>
                        <label for="analysis"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Análisis Jurídico</label>

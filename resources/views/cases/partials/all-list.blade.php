@foreach ($cases as $case)
    <div
        class="py-6 px-10 bg-white border border-gray-200 rounded-lg shadow mb-4 transform transition-transform duration-300 hover:translate-x-2 hover:-translate-y-2 hover:shadow-lg active:translate-x-2 active:-translate-y-2 active:shadow-lg">
        ...
        <div class="mb-1 flex items-center">
            <p class="text-gray-700 font-extrabold mr-1">Caso:</p>
        ...
        <div class="mb-3 flex items-center">
            <p class="text-gray-700 font-extrabold mr-1">Juicio:</p>

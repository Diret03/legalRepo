<x-app-layout>
    <div class="container mx-auto px-4 my-8 min-h-screen">
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <button id="filterToggle" class="md:hidden text-gray-500 mb-4 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-3 py-1.5">
                Mostrar Filtros
            </button>

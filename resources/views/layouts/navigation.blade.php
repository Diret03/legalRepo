        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('home')" :active="request()->routeIs('home') || request()->routeIs('/')">
                        {{ __('Inicio') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                @if (Route::has('login'))
                    @auth
                        ...
                        @endphp
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link :href="$dashboardLink" :active="request()->routeIs('dashboard') || request()->is('dashboard/*')">
                                {{ __('Dashboard') }}
                            </x-nav-link>
                        </div>
                    @endauth
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('tags.list')" :active="request()->routeIs('tags.list') || request()->is('etiquetas/*')">
                        {{ __('Etiquetas') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    ...
    @if (Route::has('login'))
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('cases.list')" :active="request()->routeIs('cases.list') || request()->is('casos/*')">
                    {{ __('Casos') }}
                </x-responsive-nav-link>

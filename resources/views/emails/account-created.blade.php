...
<head>
  ...
  <style>
    @font-face {
      ...
      font-style: normal;
      font-weight: 400;
      src: local('Figtree Regular'), local('Figtree-Regular'), url('https://fonts.gstatic.com/s/figtree/v10/_Xmt-HQyrFIqCz9NXe6p0nFssHqB.woff2') format('woff2');
    }
    @font-face {
      font-family: 'Figtree';
      font-style: normal;
      font-weight: 700;
      src: local('Figtree Bold'), local('Figtree-Bold'), url('https://fonts.gstatic.com/s/figtree/v10/_Xmt-HQyrFIqCz9NXe6p0nFsssHqB.woff2') format('woff2');
    }
  </style>
</head>
<body style="font-family: 'Figtree', sans-serif; margin: 0; width: 100%; background-color: #f8fafc; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word">
  <div style="display: none">
    Tu cuenta ha sido creada exítosamente
          ...
          <td style="width: 552px; max-width: 100%">
            <div class="sm-my-8" style="margin-top: 48px; margin-bottom: 48px; text-align: center">
              <a href="https://maizzle.com">
                <img src="{{$message->embed(public_path('img/logo-utn.png'))}}" width="70" alt="UTN Logo" style="max-width: 100%; vertical-align: middle">
              </a>
            </div>

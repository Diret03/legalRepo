...
<script>
    ...
    function setupEditButtonListeners() {
        ...
        const closeButtons = editModal.querySelectorAll('[data-modal-hide="edit-modal"]');
        ...
        $('#search').on('keyup', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    // Re-append the edit modal
                    const editModal = document.getElementById('edit-modal-template').content.cloneNode(true);

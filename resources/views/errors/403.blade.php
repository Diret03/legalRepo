    ...
    <section class="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-4xl w-full mx-4">
        <div class="py-12 px-6 text-center">
            ...
            <h1
                ...
                403</h1>
            <h2 class="mb-4 text-4xl font-bold text-gray-800">Prohibido</h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">No tienes permiso para esta acción.</p>
            <p class="mb-8 text-xl text-gray-600 max-w-2xl mx-auto">Puedes encontrar

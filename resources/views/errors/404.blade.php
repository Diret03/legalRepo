...
<section class="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-4xl w-full mx-4">
    <div class="py-12 px-6 text-center">
        <div class=" mb-8 drop-shadow-xl animate-float lg:flex lg:justify-center">
            <img src="{{asset('img/broken-justice.png')}}" alt="Balanza de justicia rota" class="ml-4 lg:ml-24 w-96 h-96 object-contain">
        </div>
        <h1 class="mb-6 text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-800">404</h1>
        ...
        <div class="flex justify-center gap-6 my-8">
            ...
            <a href="{{route('home')}}" class="group flex items-center space-x-2 bg-zinc-700 hover:bg-zinc-900 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                <img src="{{asset('svg/home.svg')}}" alt="Inicio icono" class="w-6 h-6 invert transition-transform duration-300 group-hover:rotate-12">
                <span>Inicio</span>
            </a>
        </div>
    </div>

document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('[data-modal-target]').forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            modal.querySelectorAll('ul').forEach(function(ul) {
                ul.classList.add('ml-5', 'list-disc');
            });

            // Add 'ml-5' and 'list-decimal' to ordered lists
            modal.querySelectorAll('ol').forEach(function(ol) {
            ...
            modal.querySelectorAll('h1').forEach(function(h1) {
                h1.classList.add('text-3xl', 'font-bold', 'mt-4', 'mb-2');
            });
            modal.querySelectorAll('h2').forEach(function(h2) {
                h2.classList.add('text-2xl', 'font-semibold', 'mt-4', 'mb-2');
            });
            modal.querySelectorAll('h3').forEach(function(h3) {
                h3.classList.add('text-xl', 'font-semibold', 'mt-3', 'mb-1');
            });
            modal.querySelectorAll('h4').forEach(function(h4) {
                h4.classList.add('text-lg', 'font-medium', 'mt-2', 'mb-1');
            });
            modal.querySelectorAll('h5').forEach(function(h5) {
                h5.classList.add('text-base', 'font-medium', 'mt-2', 'mb-1');
            });
            modal.querySelectorAll('h6').forEach(function(h6) {
